...
| 3 | Database | Dual data layer: PostgreSQL with Liquibase migrations on the CERPS side (3NF, functional indexes, role-based access) and Room SQLite on the device (nine entities, fourteen migrations, foreign-key cascades). | [database.md](02-technical/criteria/database.md) |

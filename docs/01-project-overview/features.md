...
| E7 | Category Analytics | Spending limits with progress ring, stacked trend chart in transaction list |
...
| US-11 | user tracking category budgets | set a monthly spending limit on a category and see remaining budget while adding a transaction | I stay within budget without manual calculation | Must |
| US-12 | user reviewing spending patterns | see a trend chart of spending per category across last 6 periods | I understand if my spending is growing or shrinking | Should |
